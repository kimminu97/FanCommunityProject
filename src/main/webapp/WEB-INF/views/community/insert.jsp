...
<body>
	...
	<form name="frm1" method="post" action="insert">
		...
		<table style="width: 80%;">
			<tr>
				<td width="30%" class="td1">제목</td>
				<td class="left"><input type="text" name="board_sub" size="70"
					class="input1" required="required"></td>
			</tr>
			<tr>
				<td class="td1">작성자</td>
				<td class="left">${users.user_name }${admin.adm_name }<input
					type="hidden" name="board_name" size="70" class="input1"
			...
			<tr>
				...
				<td class="left"><textarea rows="20" cols="80" name="board_con"
						class="input1" required="required"></textarea></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" value="저장"
					class="btn"> <!-- <a class="button" href="javascript:post_data();">저장</a> -->
