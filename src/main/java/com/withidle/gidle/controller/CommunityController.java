...
//		return "community/list2";	//pageNo 를 form data로 전달하는 예시
	...
	@RequestMapping(value = "list",params = "action=3")
	public String list3(@RequestParam(required=false , defaultValue="1") int pageNo,Model model) {  
		int board_cat=3;
		PageDto page = new PageDto(pageNo, 10, mapper.getCount(board_cat));
		model.addAttribute("board_cat", 3);
		logger.info("board_cat:",board_cat);
		Map<String, Integer> map = new HashMap<String, Integer>();
		map.put("startNo", page.getStartNo());
		map.put("endNo", page.getEndNo());
...
//		return "community/list2";	//pageNo 를 form data로 전달하는 예시
	...
	@RequestMapping(value = "list",params = "action=4")
	public String list4(@RequestParam(required=false , defaultValue="1") int pageNo,Model model) {  
		int board_cat=4;
		PageDto page = new PageDto(pageNo, 10, mapper.getCount(board_cat));
		model.addAttribute("board_cat", 4);
		logger.info("board_cat:",board_cat);
		Map<String, Integer> map = new HashMap<String, Integer>();
		map.put("startNo", page.getStartNo());
		map.put("endNo", page.getEndNo());
